...
## 3. Abstract
Kbs.IdoWeb.Api is an .net core Application that offers a generic API to deliver background services and data to the Kbs.IdoWeb.WordPress based websites (see bodentierhoch4.de)  
